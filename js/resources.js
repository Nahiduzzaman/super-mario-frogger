...
(function() {
    ...
    var readyCallbacks = [];
    /**
     * Public interface allowing to load either a single or array of images
     */
    ...
    /**
     * Private image loading function called by the public interface load
     */
    function _load(url) {
        if (resourceCache[url]) {
            // Return the chached image in case it was previously loaded
    ...
    /**
     * Public interface to get references to images previously loaded
     */
    function get(url) {
        return resourceCache[url];
    }
    ...
    /**
     * Expose the public interface through the Resources object
     */
    window.Resources = {
        load: load,
        get: get,
